...
const TICKER, INDEXNAME = "NDX", "NASDAQ 100"
const SUBTITLE = "Same overlay as QQQ, on QQQ's own index back to 1985. Here it BEATS buy &amp; hold on return AND halves drawdown — the textbook win. Cash 4%/yr, 5 bps/trade."
using Dates, Printf
