...
julia --startup-file=no analysis/signal.jl                  # ⭐ today's trade signal (the day-to-day tool); pulls fresh data only if stale (>1h) & market open. --fetch forces, --no-fetch offline
